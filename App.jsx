...
// const {
//   ethers,
// } = require("d:/vs_code/challenge-1-decentralized-staking/packages/hardhat/node_modules/hardhat/internal/lib/hardhat-lib");
/*
...
const providerSigner = localProvider.getSigner();
const providerAddress = providerSigner.getAddress();
...
function App(props) {
  ...
  const writeContracts1 = useContractLoader(providerSigner, contractConfig, localChainId);
      ...
      <BrowserRouter>
        ...
        <Switch>
          <Route exact path="/">
            ...
            <div style={{ padding: 8 }}>
              <textarea rows={1} placeholder="0.5" id="stakeAmount" onChange={onStakeAmountChange} required />
              <Button
                type={balanceStaked ? "success" : "primary"}
                onClick={() => {
                  let stAmount = parseFloat(stakeAmount);
                  if (isNaN(stAmount)) {
                    stAmount = "0.5";
                  }
                  tx(writeContracts.Staker.stake({ value: ethers.utils.parseEther(stAmount.toString()) }));
                }}
              >
                🥩 Stake ether!
              </Button>
            ...
            {/* <div style={{ padding: 8 }}>
              <Button
                type={"default"}
                onClick={() => {
                  faucetTx(writeContracts1.ExampleExternalContract.update_owner(address));
                }}
              >
                updata_owner
              </Button>
